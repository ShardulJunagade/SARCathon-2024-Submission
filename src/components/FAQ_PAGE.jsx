...
const FAQ_PAGE = () => {
  ...
  const fetchData = async () => {
    setLoader(true);
    try {
      const response = await fetch("https://sarc-search-api/search");
  ...
  return (
    <>
      ...
      <div className="faq-text">
        ...
        <p className="subtext">
          Whether you're a prospective student looking for program details, a
          parent seeking information about our curriculum, or a current student
          with inquiries about your studies, we're here to help.
        </p>
      </div>
